...
//
//describe('water_getSingle_dontCreateNew_null_params', function() {
//    it('should get todays data', function() {
//        var finished = false,
//            data;
//
...
//describe('water_getSingle_dontCreateNew_undefined_params', function() {
//    it('should get todays data', function() {
//        var finished = false,
//            data;
//
...
//});
//
//describe('water_getSingle_dontCreateNew_date_params', function() {
//    var date = moment().subtract(2, 'days').format('MM-DD-YYYY');
//    it('should get data for ' + date, function() {
//        var finished = false,
//            data;
...
//});
//
//describe('water_getSingle_dontCreateNew_future_date', function() {
//    var date = moment().add(2, 'days').format('MM-DD-YYYY');
...
//
//        runs(function() {
//            db.get.single('water', { where: { data: date } }, function(result) {
//                finished = true;
//                data = result;
//            });
//        });
